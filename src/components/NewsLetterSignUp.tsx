  ...
  return (
    <div className="px-5 py-3.5 flex flex-col bg-background-news-letter-colour items-center">
      ...
      <div className="w-[452px] h-10 justify-center items-center flex flex-row bg-white rounded-md drop-shadow-lg m-4">
        <input
          className="w-[381.94px] h-8 flex border-none focus:outline-none outline-none text- font-serif"
          type="email"
        ...
        <div className="flex justify-end items-center">
          <button
            className={`z-50 flex h-8 w-16 items-center text-center text-xs justify-center font-sans text-white rounded-md ${
      ...
      <div className="w-[452px] text-xs text-center text-gray-400">
        ...
        <span className="whitespace-normal cursor-pointer text-orange-600 underline">
          privacy policy
        </span>
