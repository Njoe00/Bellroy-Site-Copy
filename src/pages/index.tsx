    ...
    <header className="bg-white z-100">
      ...
      <div className="flex m-11 justify-center">
        <div className="flex relative">
          <iframe width="814px" height='458px' src='https://www.youtube-nocookie.com/embed/IvkAjZd8rjE?autoplay=1&loop=1&playlist=IvkAjZd8rjE&origin=bellroy.com&modestbranding=1&showinfo=0&rel=0&version=3&mute=1'/>
        </div>
        <div className="flex flex-col items-center text-center justify-center ml-14">
          ...
          <p className="flex items-center py-2 text-sm">
            <br/>Our wallets are designed to hold what you need, while <br/> keeping your pockets trim and trailored.
          </p>
        </div>
      </div>
        { slidePicture ? (
      ...
      <div className="flex justify-center flex-row bg-gray-200 p-32 space-x-6">
          ...
          <div className="flex flex-col justify-center items-center bg-gray-200 ">
            ...
            />
             <p className="p-8 text-center w-full text-sm bg-white drop-shadow-lg">
              Made from premium, environmentally certified leather,<br/> 
          ...
          <div className="absolute text-7xl text-white cursor-pointer right-2 duration-500" onClick={handleSlide}>
        ...
        <div className="flex justify-center flex-row bg-gray-200 p-32 space-x-6">
          <div className="absolute text-7xl p-2 left-5 text-white cursor-pointer duration-500" onClick={handleSlide}>
           ...
           <div className="flex flex-col justify-center items-center bg-gray-200 ">
            ...
            />
             <p className="p-8 text-center w-full text-sm bg-white drop-shadow-lg">
             their clever design features help keep them slim, even <br/> when they're full…
            </p>
          </div>
          <div className="flex flex-col justify-center items-center bg-gray-200 ">
            <Image
            ...
            />
            <p className="p-8 text-center w-full text-sm bg-white drop-shadow-lg">
              so they'll be with you from Day One to Day 1000, and <br/> beyond.
            </p>
          </div>
